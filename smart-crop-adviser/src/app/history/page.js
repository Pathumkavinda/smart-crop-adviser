...
// API URL for database connection
...
// This is a client-side function to simulate token storage for development
// In a real app, you would use a proper authentication system
const setupDevelopmentToken = () => {
...
export default function HistoryPage() {
  ...
  // Setup development token for testing
  useEffect(() => {
    setupDevelopmentToken();
  }, []);
  ...
  // Define fetchHistoryData first using useCallback
  const fetchHistoryData = useCallback(async () => {
    try {
      ...
      // Make the API request to get soil test history
      const response = await fetch(`${API_URL}/soil-history`, {
        method: 'GET',
        headers: {
            ...
            historyData.map((entry) => (
              ...
              >
                ...
                <div className="mt-4 flex justify-end">
                  {/* Option 1: Using Link component - good for SEO and performance */}
                  <Link 
                  ...
                  {/* Option 2: Using onClick with router.push - alternative approach 
                  <button 
