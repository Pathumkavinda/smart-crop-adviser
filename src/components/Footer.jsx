    ...
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
          ...
          <div className="px-5 py-2">
            <Link href="/adviser" className="text-base text-gray-500 hover:text-gray-900">
              Adviser
            </Link>
          </div>
          ...
          <div className="px-5 py-2">
            <Link href="/history" className="text-base text-gray-500 hover:text-gray-900">
              History
            </Link>
          </div>
          
          <div className="px-5 py-2">
            <Link href="/info" className="text-base text-gray-500 hover:text-gray-900">
              Information
            </Link>
          </div>
        ...
        <div className="mt-8 text-center">
          ...
          <p className="mt-2 text-sm text-gray-500 flex items-center justify-center">
            Made with <Heart className="h-4 w-4 text-red-500 mx-1" /> for Sri Lankan farmers
          </p>
